 ...
 * @author JK Lee
 */
app.tetris.GameView = Backbone.View.extend({
	defaults : {
		oWebGLView : {},
		bWebGLOn : false
	},
	 ...
	 */
	initialize : function(){
		this.oWebGLView = this.options.oWebGLView;
		this.oUIView = this.options.oUIView;
		...
		this.bWebGLOn = this.options.bUseWebGL ? this.options.bUseWebGL : false; 
	...
	initResources : function(){
		...
		this.blockImg[22].src = './img/mino_main.png';
		
		this.blockImg[10] = new Image();
		this.blockImg[10].src = './img/mino_sub.png';
	...
	initAudio : function(){
		...
		this.htSound['harddrop'] = new buzz.sound('sound/TE_SE_harddrop.'+ext, {preload : true});
		
		this.htSound['softdrop'] = new buzz.sound('sound/TE_SE_softdrop.'+ext, {preload : true});
		this.htSound['lockdown'] = new buzz.sound('sound/TE_SE_lockdown.'+ext, {preload : true});
